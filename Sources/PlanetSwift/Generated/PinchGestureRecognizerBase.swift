...
open class PinchGestureRecognizerBase: GestureRecognizer {

	open func customCopyTo(_ other: PinchGestureRecognizer) {
        // can be overriden by subclasses to provide custom copying
    }

    open override func copy() -> GaxbElement {
        let copied = super.copy() as! PinchGestureRecognizer
    ...
    override  open func isKindOfClass(_ className: String) -> Bool {
        if className == "PinchGestureRecognizer" {
            return true
        }
    ...
    override open func toXML(_ useOriginalValues: Bool) -> String {
        var xml = "<PinchGestureRecognizer"
        ...
        xml += sXML == "" ? "/>": ">\(sXML)</PinchGestureRecognizer>"
        return xml
    }
