...
private let constraintParentKeyword = "parent"
...
public class Constraint: ConstraintBase {
    ...
    internal func firstView() -> UIView? {
        if let item = self.firstItem {
            if item == constraintParentKeyword {

                // avoid an infinite loop if both are looking for super view
                if let secondItem = secondItem, secondItem == constraintParentKeyword {
                    return nil
                }
    ...
    internal func secondView() -> UIView? {
        if let item = self.secondItem {
            if item == constraintParentKeyword {
                ...
                // avoid an infinite loop if both are looking for super view
                if let firstItem = firstItem, firstItem == constraintParentKeyword {
                    return nil
                }
