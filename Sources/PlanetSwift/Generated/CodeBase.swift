...
open class CodeBase: Object {
    ...
    open func setClassName(_ value: String) {
        self.className = String(gaxbString: value)
    }
	...
	if let obj = receiver as? ObjectBase {
            if originalValues["className"] != nil && obj.originalValues["className"] == nil {
				obj.setAttribute(originalValues["className"]!, key: "className")
            }
       }
    ...
    override open func attributesXML(_ useOriginalValues: Bool) -> String {
        ...
        if useOriginalValues {
            ...
            if className != nil {
                xml += " className='\(classNameAsString())'"
            }
            }
