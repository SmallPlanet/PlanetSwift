...
open class PickerViewBase : View {


	open func customCopyTo(_ other:PickerView) {
        // can be overriden by subclasses to provide custom copying
    }

    open override func copy() -> GaxbElement {
        let copied = super.copy() as! PickerView
